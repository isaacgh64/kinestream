...
export default function Stream() {
  ...
  return (
    <div className="sm:max-w-xs inline-block bg-white overflow-hidden rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 mt-6 me-3 w-64 cursor-pointer" onClick={() => dispatch({type:"add-stream", payload:{id_stream:1,view_stream:false}}) }>
      <img 
